    ...
    <div class="main-layout">
        <div class="content-area">
            <div class="info-card">
                ...
                <p>View all customer reviews and ratings for products</p>
            </div>

            <div class="table-container">
                <h3 style="color: #2d3748; margin-bottom: 15px;">📝 All Customer Reviews</h3>
                <table>
        <tr>
            <th>Review ID</th>
            <th>Customer ID</th>
        ...
        <?php if (mysqli_num_rows($result) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td><span class="rating-stars"><?php echo $row['rating']; ?></span></td>
                    <td><?php echo htmlspecialchars($row['comment']); ?></td>
                </tr>
            <?php endwhile; ?>
        <?php else: ?>
            <tr>
                <td colspan="7" style="text-align:center; color: #718096; padding: 30px;">No reviews found.</td>
            </tr>
        <?php endif; ?>
    </table>
            </div>
